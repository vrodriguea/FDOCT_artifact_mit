...
def define_gan(g_model, d_model, image_shape, L=1.0, M=1.0, N=1.0):
    ...
    - L, M, N: Coeficientes para ponderar las pérdidas de contenido, características y adversariales respectivamente.
    
    Retorna:
    - model: El modelo GAN compilado.
    """
    # Congelar los pesos del discriminador
    ...
    # Utilizamos nuestra función de pérdida total personalizada
...
def summarize_performance(step, g_model, dataset, n_samples=3):
	...
	filename1 = 'plot_pixloss2_%06d.png' % (step+1)
	pyplot.savefig(filename1)
	pyplot.close()
	# save the generator model
	filename2 = 'model_pix2loss2_%06d.h5' % (step+1)
